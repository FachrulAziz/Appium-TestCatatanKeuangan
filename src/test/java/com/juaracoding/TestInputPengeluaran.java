...
public class TestInputPengeluaran {
    ...
    @Test
    public void inputPngeluaran() {
        delay(3);
        MobileElement tambah = driver.findElementById("com.chad.financialrecord:id/fabMenu");
        tambah.click();
        delay(2);
        MobileElement pilihKategori = driver.findElementById("com.chad.financialrecord:id/btnExpense");
        pilihKategori.click();
        delay(2);
        MobileElement Pilihtanggal = driver.findElement(By.id("com.chad.financialrecord:id/tvDate"));
        Pilihtanggal.click();
        delay(2);
        MobileElement tanggalDipilih = driver.findElementByAccessibilityId("17 Juni 2023");
        ...
        delay(2);
        MobileElement pilih = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[3]/android.widget.LinearLayout/android.widget.TextView");
        pilih.click();
        delay(2);
        MobileElement pemasukan = driver.findElementById("com.chad.financialrecord:id/etAmount");
        pemasukan.sendKeys("50000");
        delay(2);
        MobileElement catatan = driver.findElementById("com.chad.financialrecord:id/etNote");
        catatan.sendKeys("Perbaikan Motor");
        delay(2);
